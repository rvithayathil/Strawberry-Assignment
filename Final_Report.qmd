---
title: "Herbicide Usage in Strawberry Production"
...
![](https://grist.org/wp-content/uploads/2010/06/strawberrypoison.jpg?quality=75&strip=all){alt="Poison Strawberry" style="display:block;margin:auto;"}
...
After completing the sheet we saw that there were 6 unique Toxicity categories for our herbicides. We then reformatted the toxicity data so that there were 6 binary columns (one for each toxicity category). You can check our Data branch to get code and detail information as well as our .
...
<https://quickstats.nass.usda.gov/> - Farming and usage information by state and year

<https://pubchem.ncbi.nlm.nih.gov/#query=108800> - Toxicity information by herbicide

<https://www.epa.gov/newsreleases/epa-issues-emergency-order-stop-use-pesticide-dacthal-address-serious-health-risk-4> - Herbicide DPCA was no longer in the PubChem database likely because it has been banned. Use this source for toxicity information.
