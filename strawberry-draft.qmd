...
Most states (3) show a **negative correlation**—higher organic share corresponds to lower herbicide coverage in conventional areas.
A few states (1) exhibit a **positive correlation**, where an increase in organic share coincides with higher coverage rates.
